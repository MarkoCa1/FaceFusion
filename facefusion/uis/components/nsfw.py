...
# 初始化模型
classifier = pipeline('image-classification', model="/root/autodl-fs/model/Falconsai/nsfw_image_detection/")
...
def same_face(sample_image_sources, reference_images_dir="/root/autodl-fs/face"):
	# 加载参考图片，并对每张图片进行编码
